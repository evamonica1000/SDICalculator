  ...
  return (
    <div className="min-h-screen bg-blue-900 text-white">
      <main className="container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold mb-6">Scale Indices Calculator for Cooling Water System</h1>
        
        <div className="bg-white text-black p-6 rounded-lg shadow-lg mb-8">
          <section className="mb-6">
            <h2 className="text-2xl font-semibold mb-2 text-blue-800">Overview</h2>
            <p>
          ...
          <section className="mb-6">
            <h2 className="text-2xl font-semibold mb-2 text-blue-800">Instructions</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-2 text-blue-800">Built-in Help</h2>
